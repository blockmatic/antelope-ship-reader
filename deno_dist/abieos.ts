...
export class AbiEos {
  ...
  jsonToHex(contractName, type, json) {
    ...
    const resultPtr = this.abieos.symbols.json_to_hex(
      contractPtr,
      typePtr,
      jsonPtr,
    );
  ...
  hexToJson(contractName, type, hex) {
    ...
    const resultPtr = this.abieos.symbols.hex_to_json(
      contractPtr,
      typePtr,
      hexPtr,
    );
  ...
  binToJson(contractName, type, buffer) {
    ...
    const resultPtr = this.abieos.symbols.bin_to_json(
      contractPtr,
      typePtr,
      bufferPtr,
      size,
  ...
  getTypeForAction(contractName, actionName) {
    ...
    const resultPtr = this.abieos.symbols.get_type_for_action(
      contractPtr,
      actionNamePtr,
    );
    return this.ptr2cstr(resultPtr);
  ...
  getTypeForTable(contractName, tableName) {
    ...
    const resultPtr = this.abieos.symbols.get_type_for_table(
      contractPtr,
      tableNamePtr,
    );
    return this.ptr2cstr(resultPtr);
