export class AbiEos {
  abieos: any;
  constructor() {
    this.abieos = Deno.dlopen("./bin/abieos.so", {
      ...
      "json_to_hex": { parameters: ["pointer", "pointer", "pointer"], result: "pointer" },
      "hex_to_json": { parameters: ["pointer", "pointer", "pointer"], result: "pointer" },
      "bin_to_json": { parameters: ["pointer", "pointer", "pointer", "u32"], result: "pointer" },
      "load_abi": { parameters: ["pointer", "pointer"], result: "bool" },
      "load_abi_hex": { parameters: ["pointer", "pointer"], result: "bool" },
      "get_type_for_action": { parameters: ["pointer", "pointer"], result: "pointer" },
      "get_type_for_table": { parameters: ["pointer", "pointer"], result: "pointer" },
